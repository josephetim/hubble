...
export default function LandingPage() {
   ...
   <div className="flex flex-col justify-center self-center px-20 pt-14 pb-16 mt-36 w-full bg-[#1B1B1B] max-w-[1200px] rounded-[64px] max-md:px-5 max-md:mt-10 max-md:max-w-full">
         ...
         <div className="mt-16 max-md:mt-10 max-md:max-w-full">
           <div className="flex gap-5 max-md:flex-col max-md:gap-0">
             <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
               <div className="flex flex-col grow justify-center px-10 py-14 w-full text-white bg-[#161616] rounded-[48px] max-md:px-5 max-md:mt-10 max-md:max-w-full">
                 <div className="text-[40px] font-bold leading-9 text-left">
                   Extensive Reach
                 </div>
                 <div className="mt-4 font-light text-[20px] leading-8">
         ...
         <div className="flex flex-col justify-center p-14 mt-20 bg-blue-800 rounded-[48px] max-md:px-5 max-md:mt-10 max-md:max-w-full">
           <div className="flex gap-5 justify-between w-full max-md:flex-wrap max-md:max-w-full">
             ...
             <div className="flex gap-2 text-xl max-md:flex-wrap max-md:max-w-full">
               <input className="items-start px-8 font-medium pt-2.5 pb-4 text-black bg-white border border-gray-300 border-solid shadow-sm leading-[120%] rounded-[80px] max-md:px-5"
